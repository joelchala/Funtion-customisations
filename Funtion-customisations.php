<?php
/**
 * Plugin Name:       Funtion-customisations
 * Description:       A handy little plugin to contain your Funtion customisation snippets.
 * Plugin URI:        http://github.com/wooFuntions/Funtion-customisations
 * Version:           1.0.0
 * Author:            WooFuntions
 ...
 * Tested up to:      5.9.0
 *
 * @package Funtion_customisations
 */
...
/**
 * Main Funtion_customisations Class
 *
 * @class Funtion_customisations
 * @version	1.0.0
 * @since 1.0.0
 * @package	Funtion_customisations
 */
final class Funtion_customisations {

	/**
	 * Set up the plugin
	 */
	public function __construct() {
		add_action( 'init', array( $this, 'Funtion_customisations_setup' ), -1 );
	 ...
	 */
	public function Funtion_customisations_setup() {
		add_action( 'wp_enqueue_scripts', array( $this, 'Funtion_customisations_css' ), 999 );
		add_action( 'wp_enqueue_scripts', array( $this, 'Funtion_customisations_js' ) );
		add_filter( 'template_include',   array( $this, 'Funtion_customisations_template' ), 11 );
		add_filter( 'wc_get_template',    array( $this, 'Funtion_customisations_wc_get_template' ), 11, 5 );
	}
	 ...
	 * @return void
	 */
	public function Funtion_customisations_css() {
	 ...
	 * @return void
	 */
	public function Funtion_customisations_js() {
	 ...
	 */
	public function Funtion_customisations_template( $template ) {
	 ...
	 */
	public function Funtion_customisations_wc_get_template( $located, $template_name, $args, $template_path, $default_path ) {
 ...
 * @return void
 */
function Funtion_customisations_main() {
	new Funtion_customisations();
}

/**
 * Initialise the plugin
 */
add_action( 'plugins_loaded', 'Funtion_customisations_main' );
